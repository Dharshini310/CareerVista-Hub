  ...
  render() {
    return (
      <div classname="s">
        ...
        <b id="co">Discover a wide range of online courses that are tailored to help you gain in-depth knowledge and advance your expertise. By clicking here, you can access valuable resources designed to enhance your learning and support your growth in the field.!!&nbsp;&nbsp;<Link to="/course" id="cu">CLICK HERE</Link></b><br />
        ...
        <b id="in">Explore a variety of internship opportunities that allow you to apply your knowledge and skills in real-world settings. By clicking here, you can access valuable internships that provide hands-on experience, helping you bridge the gap between learning and practical application.!!&nbsp;&nbsp;<Link to="/intern" id="cu">CLICK HERE</Link></b>
      </div>
    )
  }
}
