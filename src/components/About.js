  ...
  render() {
    return (
      <div id="s">
        ...
        <b id="x">Contains several coding platforms. Which helps in enriching your skills&nbsp;&nbsp; <Link to="/blank" id="cu">CLICK HERE</Link></b><br />
        ...
        <b id="co">Contains several online courses. Which helps in gaining knowledge&nbsp;&nbsp;<Link to="/course" id="cu">CLICK HERE</Link></b><br />
        ...
        <b id="in">Contains several internships. Which helps in applying your knowledge and skills&nbsp;&nbsp;<Link to="/intern" id="cu">CLICK HERE</Link></b>
      </div>
    )
  }
}
