  ...
  render() {
    return (
      <div id="s">
        ...
        <text id="x">Explore a variety of coding platforms that provide a comprehensive environment to enhance and refine your coding skills.&nbsp;&nbsp; <Link to="/blank" id="cu">CLICK HERE</Link></text><br />
        </div>
        <div>
        ...
        <text id="co">Discover a wide range of online courses that are tailored to help you gain in-depth knowledge and advance your expertise.&nbsp;&nbsp;<Link to="/course" id="cu">CLICK HERE</Link></text><br />
          </div>
          <div>
          ...
          <text id="in">Explore a variety of internship opportunities that allow you to apply your knowledge and skills in real-world settings.een &nbsp;&nbsp;<Link to="/intern" id="cu">CLICK HERE</Link></text>
            </div>
            </div>
    )
  }
